  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: '1.1rem', marginBottom: 16 }}>
        We appreciate the effort you put into your application and thank you for
        considering our platform. Unfortunately, after a careful review, we have
        determined that your application does not meet our current requirements.
      </p>
      ...
      <div style={{ fontSize: 13, color: '#888', marginBottom: 24 }}>
        You received this email because you applied as a seller on the{' '}
