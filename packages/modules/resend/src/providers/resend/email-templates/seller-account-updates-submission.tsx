...
export const SellerAccountSubmissionEmailTemplate: React.FC<
...
> = ({ data }) => {
  return (
    ...
    >
      ...
      <p>
        Your application is currently being reviewed by our team. Please expect
        a response within [three] business days. If your submission meets our
        criteria and is accepted, you will receive a confirmation email from us.
      </p>
      <p>
