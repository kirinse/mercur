...
export class Migration20260212180531 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table if not exists "seller" ("id" text not null, "store_status" text check ("store_status" in ('ACTIVE', 'INACTIVE', 'SUSPENDED')) not null default 'ACTIVE', "name" text not null, "handle" text not null, "description" text null, "photo" text null, "email" text null, "phone" text null, "address_line" text null, "city" text null, "state" text null, "postal_code" text null, "country_code" text null, "tax_id" text null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "seller_pkey" primary key ("id"));`);
